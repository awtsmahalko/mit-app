    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class=" d-flex align-items-center flex-column">
                            <img class="img-fluid rounded my-4" src="../../assets/img/profile.jpg" height="250" width="250" alt="User avatar" />
                            <div class="user-info text-center">
                                <h4 class="mb-2">Eduard Rino Carton</h4>
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item"><a class="nav-link" href="app-user-view-billing.html"><i class="bx bx-detail me-1"></i>Logs History</a></li>
            ...
            <!-- Project table -->
            <div class="card mb-4">
                <h5 class="card-header">User's Vaccine History</h5>
                    ...
                    <table class="table datatable-project border-top">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Pfizer</td>
                                <td>Nov 21, 2021</td>
                                <td><span class="badge bg-label-primary me-1">1st dose</span></td>
                                <td>SM Bacolod</td>
                                <td>Dra. Belo</td>
                            </tr>
                            <tr>
                                ...
                                <td>Pfizer</td>
                                <td>Dec 23, 2021</td>
                                <td><span class="badge bg-label-success me-1">2nd dose</span></td>
                                <td>SM Bacolod</td>
                                <td>Dra. Belo</td>
                            </tr>
                        </tbody>
            ...
            <!-- Activity Timeline -->
            <div class="card mb-4">
                <h5 class="card-header">Beneficiary Timeline</h5>
                <div class="card-body">
                    <ul class="timeline">
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                <div class="timeline-header mb-1">
                                    <h6 class="mb-0">SM Bacolod</h6>
                                    <small class="text-muted">12 min ago</small>
                                </div>
                                <p class="mb-2">North Entrance</p>
                                <div class="d-flex">

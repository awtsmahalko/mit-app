<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-2">Vaccine List</h4>

    <p>The vaccines listed below are those that have been approved, authorized, licensed, granted emergency use authorization, or made available for use outside of clinical trials via any pathway by a regulatory agency, a national authority, or another entity.</p>
    <!-- Role cards -->
    <div class="row g-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-end">
                        <div class="role-heading">
                            <h4 class="mb-1">Anhui Zhifei Longcom</h4>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                        <h6 class="fw-normal">Comirnaty</h6>
                        <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Vinnie Mostowy" class="avatar avatar-sm pull-up">
                                <img class="rounded-circle" src="../assets/img/avatars/5.png" alt="Avatar">
                            </li>
                    ...
                    <div class="d-flex justify-content-between align-items-end">
                        <div class="role-heading">
                            <h4 class="mb-1">Pfizer/BioNTech</h4>
                            <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#addRoleModal" class="role-edit-modal"><small>Edit
                                    Vaccine</small></a>
                        </div>
                        <a href="javascript:void(0);" class="text-muted"><i class="bx bx-copy"></i></a>
                    ...
                    <div class="col-sm-7">
                        <div class="card-body text-sm-end text-center ps-sm-0">
                            <button data-bs-target="#addRoleModal" data-bs-toggle="modal" class="btn btn-primary mb-3 text-nowrap add-new-role">Add New
                                Vaccine</button>
                            <p class="mb-0">Add, if it does not exist</p>
                        </div>
                    </div>
                </div>
            </div>

...
if(isset($data->user_id) && !empty($data->user_id) ){
	...
	$response['total_pr'] = $count_total_pr[0];
	$response['total_pending_pr'] = $count_total_pending_pr[0];
	$response['total_finished_po'] = $count_total_finished_po[0];
	$response['total_released_stocks'] = $count_total_release_stocks[0];

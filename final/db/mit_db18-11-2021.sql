...
# Database: mit_db
# Generation Time: 2021-11-18 03:09:47 +0000
# ************************************************************
...
LOCK TABLES `mit_user` WRITE;
/*!40000 ALTER TABLE `mit_user` DISABLE KEYS */;

INSERT INTO `mit_user` (`id`, `username`, `password`)
VALUES
	(1,'demo','$2y$10$K/a3HiqKgQGb3X2SdHdIne5lQk5j87e6s3IYB4MpecS2mRBu3TvNS'),
	(2,'rino','$2y$10$7iWNa017A9u/ztchmAxkUOAhBv6R0IucnE6n.KSDqI0mPqNLvNxby'),
	(11,'awtsmahalko','$2y$10$u5Ezeu3dlORCTm6CNR3BXOCvXhtVW7YvFtBJhu6xFy4sGJCCBaKae'),
	(12,'rin','$2y$10$O0amKVM4ZsnkAowuxZKobOj8idBDCajKuTG20/FRx4eNtZ.O1A1Ay'),
	(13,'a','$2y$10$W8sJ80cqM6uCuIkhm7zatuEAQ0ztRcSFUv4fSDyVSC3ghxeVkTTvG');

/*!40000 ALTER TABLE `mit_user` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	(1,'Admin',' ','Assistant','AA','eduard16carton@gmail.com','09096836075','admin','0cc175b9c0f1b6a831c399e269772661',NULL,'2021-11-18 11:06:42'),
	(4,'Inspection',' ','Officer','IO','eduard16carton@gmail.com','09096836075','io','f98ed07a4d5f50f7de1410d905f1477f',NULL,'2021-11-18 11:06:29'),
	(5,'Property','Custodian','Elem','PC','eduard16carton@gmail.com','09096836075','pcelem','bc54f4d60f1cec0f9a6cb70e13f2127a','ELEM','2021-11-18 11:07:11'),
	(6,'BAC',' ',' ','BAC','eduard16carton@gmail.com','09096836075','bac','79ec16df80b57696a03bb364410061f3',NULL,'2021-10-13 09:18:49'),
	(8,'Property','Custiodian','JHS','PC','eduard16carton@gmail.com','09096836075','pcjhs','902cd45de9df829eaa7c7e779731b8cd','JHS','2021-11-18 11:05:50'),
	(9,'Property','Custodian','SHS','PC','eduard16carton@gmail.com','09096836075','pcshs','bcce08e3d96971b1a1434b88d05354ac','SHS','2021-11-18 11:06:12');

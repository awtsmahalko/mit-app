...
# Database: pims_db
# Generation Time: 2021-11-15 08:52:32 +0000
# ************************************************************
...
INSERT INTO `tbl_purchase_order_header` (`po_id`, `pr_id`, `po_date`, `canvass_id`, `supplier_id`, `date_modified`, `user_id`, `po_status`, `io_id`, `pc_id`)
VALUES
	(1,1,'2021-10-22',2,1,'2021-10-22 09:24:24',1,'FS',4,5);
...
VALUES
	...
	(2,'2021-07-002-ELEM','2021',7,2,'ELEM','2021-10-21','Office Supplies','P','Shopping','Office Supplies','',1,6,'2021-10-21 14:05:33'),
	(3,'2021-07-003-ELEM','2021',7,3,'ELEM','2021-10-22','Office Supplies','A','Small Value','Other supplies and materials','3,1,4',1,6,'2021-10-22 08:28:03'),
	(4,'2021-07-001-JHS','2021',7,1,'JHS','2021-10-22','OFFICE SUPPLIES','A','Small Value','Office Supplies','3,1,4',1,6,'2021-10-22 09:20:39');
...
VALUES
	(1,'2021-11-001-ELEM-ISSUE',1,'2021-11-04','ELEM','S',12,'a',5,'2021-10-29 10:06:06');

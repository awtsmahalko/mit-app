<div class="container-fluid">
    ...
    <?php require_once 'modals/modal_packaging.php'; ?>
</div>
...
var tb = "tbl_packaging";
var keyword = "packaging_id";
...
$.ajax({
    ...
    success:function(data){
        ...
        $("#hidden_id").val(json.packaging_id);
        $("#packaging_name").val(json.packaging_name);
        $("#actual_qty").val(json.actual_qty);
...
function getEntries(){
	...
	$("#dt_entries").DataTable({
		"processing":true,
		"ajax":{
			"url":"ajax/datatables/packaging.php",
			"dataSrc":"data"
		},
		"columns":[
		{

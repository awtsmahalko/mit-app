<div class="card shadow mb-4">
    <div class="card-body">
        <table width="100%" style="font-size: 10pt;">
            <tr align="center">
                <td colspan="7"><img src="img/deped.png" style="height: 73px;"></td>
            </tr>
            <tr align="center">
            ...
            <tr align="center">
                <td colspan="7" style="font-weight: bold;">RESOLUTION # <span style="text-decoration:underline;">07-015</span>, S. 2021</td>
            </tr>
            <tr>
                <td colspan="7">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="7"><span style="font-weight: bold;margin-left:10%;">WHEREAS</span>, the Himoga-an Baybay Integrated School distributed the Request for Quotation for the <b>OFFICE SUPPLIES </b> to three (3) prospective suppliers;</td>
            </tr>
            <tr>
                <td colspan="7">&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="4">To declare <b>CIAN & CYAN SCHOOL SUPPLIES TRADING</b> as the Bidder with the Lowest Calculated & Responsive Bid for the <b>OFFICE SUPPLIES</b>.</td>
            </tr>
            <tr>
